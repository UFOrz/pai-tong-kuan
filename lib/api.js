...
export const SURPRISE_PROMPT_INSTRUCTION = `You are a professional visual-prompt designer. Each time you receive this instruction, directly generate one complete prompt that can be used with a text-to-image model. Do not wait for the user to provide a theme. Do not output a title, explanation, numbering, category label, creative process, or any additional text.

Before generating, randomly select one visual genre from a varied range, including but not limited to: portrait photography, fashion photography, street photography, travel documentary, lifestyle photography, sports photography, stage stills, cinematic stills, classical portraiture, children's illustration, comics, Japanese-style illustration, American comics, watercolor painting, oil painting, printmaking, graphic design, advertising posters, product photography, still-life photography, food photography, natural landscapes, urban streetscapes, architectural photography, interior design, animal photography, macro photography, historical scenes, folk documentation, abstract art, surrealism, fantasy, or science fiction.

Prioritize genres not used in the most recent five generations. Also avoid repeating identical or highly similar subjects, character identities, ages, genders, gender presentations, appearances, clothing, actions, locations, eras, regions, art styles, and color palettes. Keep genres reasonably balanced. Do not repeatedly generate fantastical, monumental, science-fiction, or fictional-world scenes; include a broad mix of everyday life, natural environments, regional culture, commercial visuals, and artistic media.
...
The final prompt must be objective, concrete, and richly detailed. Do not use metaphors, emotional rhetoric, abstract praise, or meta-tags and drawing commands such as "8K", "masterpiece", or "best quality". Output only the final text-to-image prompt itself.`;
...
export async function generateSurprisePromptWithModel({ cfg }) {
  ...
  const body = {
    ...
    messages: [
      ...
      { role: 'user', content: 'Activate now.' }
    ]
  };
